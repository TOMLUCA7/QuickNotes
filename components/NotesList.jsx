...
const NotesList = ({notes}) => {
  return (
    <div style={{flexDirection: 'row', gap: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid black', borderRadius: '10px', padding: '10px', marginBottom: '10px'}}>
      {notes.map(note => (
